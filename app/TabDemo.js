...
const TAB_NORMAL_1 = require('./img/icon1.png');
const TAB_NORMAL_2 = require('./img/icon2.png');
const TAB_NORMAL_3 = require('./img/icon3.png');
const TAB_NORMAL_4 = require('./img/icon4.png');

const TAB_PRESS_1 = require('./img/icon5.png');
const TAB_PRESS_2 = require('./img/icon6.png');
const TAB_PRESS_3 = require('./img/icon7.png');
const TAB_PRESS_4 = require('./img/icon8.png');
//首页
